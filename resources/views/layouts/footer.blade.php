    ...
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="http://serkom.test/" class="flex items-center">
                    <img src="img/logo.png" class="mr-3 h-12" alt="Beasiswa Indonesia Logo" />
                </a>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-200 sm:text-center dark:text-gray-400">© 2024 <a href="http://serkom.test/" class="hover:underline">Beasiswa Indonesia™</a>. All Rights Reserved.
            </span>
